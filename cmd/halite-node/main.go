...
type node struct {
	...
	// metrics is what this node counts about itself, written to
	// `metrics_textfile` by the agent. Never nil; a node that records
	// nothing gets one whose families are all nil.
	metrics *nodeMetrics
