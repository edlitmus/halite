...
line — see [docs/service.md](docs/service.md) for those, the FreeBSD rc.d
scripts, and the systemd units.
...
* [docs/service.md](docs/service.md) — config files, FreeBSD rc.d, systemd units
