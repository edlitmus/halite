...
this build ships 60 execution modules and 41 state modules against a
specification naming roughly 90 and 46 — 379 execution functions across 60
...
and macOS has run only the `mac_defaults` and `mac_power` live tests
